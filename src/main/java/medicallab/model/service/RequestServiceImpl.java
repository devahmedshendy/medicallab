...
@Service
@Transactional
public class RequestServiceImpl extends RequestSpecifications implements MedicalRequestsService {
	...
	public RequestServiceImpl(RequestRepository requestRepo,
			...
			CBCRepository cbcRepo,
			UMTRepository umtRepo,
			FMTRepository fmtRepo) {
...
//			FMT fmt = fmtRepo.findByRequestCode(requestDetails.getRequestCode());
	...
	public DoctorReviewDetails updateDoctorReview(DoctorReviewDetails doctorReviewDetails) {
		if ("CBC".equals(doctorReviewDetails.getTestType())) {
			...
			cbc.setRequestStatus(RequestStatusEnum.valueOf(doctorReviewDetails.getRequestStatus()).getValue().toUpperCase());
			...
			umt.setRequestStatus(RequestStatusEnum.valueOf(doctorReviewDetails.getRequestStatus()).getValue().toUpperCase());
			...
			fmt.setRequestStatus(RequestStatusEnum.valueOf(doctorReviewDetails.getRequestStatus()).getValue().toUpperCase());
	...
	@Override
	public Page<MedicalRequestView> filter(Pageable pageable, Searchable searchable) throws NumberFormatException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Page<MedicalRequestView> filterByDoctorUsername(String doctorUsername, Pageable pageable, Searchable searchable) {
		// TODO Auto-generated method stub
		return null;
	}
}
