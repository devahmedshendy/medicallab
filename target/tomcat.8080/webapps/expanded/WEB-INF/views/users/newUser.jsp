...
<c:set value='${uri.get("newUser") }' var="newUserUri"></c:set>
...
<div class="container">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-8">
       ...
       <sf:form action="${newUserUri }" method="POST" commandName="addUserForm" cssClass="row justify-content-center">
        <div class="col-4">
        ...
        <div class="col-10"><hr></div>
         ...
         <div class="col-4">
           <a href="${usersUri }" class="btn btn-outline-danger btn-block btn-sm">Cancel</a>
         </div>
